...
SELECT SYSDATE, TO_CHAR (SYSDATE, 'YYYY.MM.DD DAY') FROM DUAL; -- '2019.11.05 화요일'
...
9(구) : 자리수를 나타내며, 자리수가 맞지 않을 경우 채우지 않음(표시 안함)
L : 지역통화 기호 표시
. (점) : 소수점
, (콤마) : 1000단위 구분 기호
-------------------------------------------*/
...
SELECT '12300' * 100 FROM DUAL; --문자타입 * 100 : 오라클에서 자동 형변환 처리
SELECT TO_NUMBER('12300') * 100 FROM DUAL; --숫자타입값 * 100
--===============================================
