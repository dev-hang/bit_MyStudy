...
********************************/
SELECT * FROM DUAL; -- DUAL : 오라클에서 제공하는 더미 테이블
...
SELECT LENGTHB('홍길동123') FROM DUAL; -- BYTE 단위
----------------------------------------------------------------
--SUBSTR(대상, 시작위치, 길이) : 문자열의 일부 추출
--   (시작위치는 1부터 시작, 오른쪽에서 시작하는 경우 마이너스(-)값 사용)
...
--INSTR(대상, 찾는문자, 시작위치)
--INSTR(대상, 찾는문자, 시작위치, nth) : nth 찾은값의 순서값(3 : 3번째 찾은 값)
SELECT INSTR('900101-1234567', '-') FROM DUAL; --7 번째에 위치
SELECT INSTR('900101-1234567', '*') FROM DUAL; --0 (없음)
SELECT INSTR('900101-1234567', '34') FROM DUAL; --10 위치값
SELECT INSTR('900101-1234567', '1', 7) FROM DUAL; --8 : 7번째 위치에서부터 
SELECT INSTR('900101-1234567', '1', 1, 3) FROM DUAL;  --8 : 처음부터 3번째 찾은 위치
----------------------------------------------------------------
--TRIM('문자열') : 양쪽 공백 제거
--LTRIM('문자열') : 왼쪽에 있는 공백 제거
--RTRIM('문자열') : 오른쪽에 있는 공백 제거
