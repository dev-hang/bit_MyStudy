...
-- CEIL(숫자) : 소수점 아래에서 무조건 올림
SELECT CEIL(30.999), CEIL(30.0001) FROM DUAL;
...
-- TRUNC(숫자) : 정수만 남기고, 소수부 버림
-- TRUNC(숫자, 자리수) : 정수 이하 자리수까지 유지 
SELECT TRUNC(30.54), TRUNC(30.99), TRUNC(30.49) FROM DUAL;
SELECT TRUNC(30.54, 1), TRUNC(30.99, 1), TRUNC(30.49, 1) FROM DUAL;

-- MOD(숫자, 나누는수) : 숫자를 나눈 나머지
...
-- POWER(숫자, n) : 숫자의 n제곱 근 값 계산(POWER(2, 3) -> 8) 
SELECT POWER(2, 3), POWER(2, 4), POWER(2, 8), POWER(2, 16) FROM DUAL;
