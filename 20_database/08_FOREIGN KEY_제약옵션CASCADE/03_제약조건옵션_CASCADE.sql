--(실습) EMP02, EMP01 외래키(FOREIGN KEY) 이름 변경 처리
...
ALTER TABLE DEPT DISABLE PRIMARY KEY; --참조테이블이 없으므로 해제 처리됨
...
--방법2 : DEPT 테이블의 PK 비활성화 시키면서 EMP01, EMP02, EMP03 함께 비활성화 처리
