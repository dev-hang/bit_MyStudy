...
<%-- EL(Expression Language) : 표현언어
	1. 표현식을 대신해서 사용 : ${ }
		<%=변수명 %> ---> ${변수명}, ${계산식}
	2. 변수값 표시할 경우 반드시 scope 안에 변수(속성)가 존재해야함
...
--%>
	...
	<h2>EL(Expression Language) 표현언어 사용 예</h2>
	<ul>
		<li>15 + 7 = ${15 + 7 }</li>
		<li>15 - 7 = ${15 - 7 }</li>
		<li>15 * 7 = ${15 * 7 }</li>
	...
	<ul>
		...
		<li>표현식(스크립트릿변수) su3 : 15 - 7 = <%=su3 %></li>
	</ul>
	<ol>
		<li>EL(선언부변수) su2 : 15 + 7 = ${su2 } ::</li>
		<li>EL(스크립트릿변수) su3 : 15 - 7 = ${su3 } ::</li>
	</ol>
	...
	<ol>
		<li>EL(선언부변수) su2 : 15 + 7 = ${su2 } ::</li>
		<li>EL(스크립트릿변수) su3 : 15 - 7 = ${attr_su3 } ::</li>
	</ol>
	<hr><hr>
