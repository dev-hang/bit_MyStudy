...
public class GenericWildcardExam {
	...
	public static void main(String[] args) {
		...
		//box2.setObl("문자열"); //컴파일오류
		//box2.setObl(100.0); //컴파일오류
		box2.setObj(100);
		box2.setObj(new Integer(1000));
		
		System.out.println("--------------------------");
		//<?> 모든 것을 담을 수 있는 형태(Object 타입과 동일한 효과)
		...
		//컴파일 오류 : Type mismatch: cannot convert from BoxT<String> to BoxT<? extends Number>
