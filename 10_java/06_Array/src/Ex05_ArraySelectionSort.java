...
//		if (num[0] > num[1]) {
//			int temp = num[0]; //첫번째 데이터 백업
//			num[0] = num[1]; //복사(0번 인덱스 <-> 1번 인덱스값)
//			num[1] = temp; //백업 데이터 복사
//		}
//		printData(num);
//		
//		//첫번째 값 기준으로 세번쩨 값과 비교작업(인덱스0 - 인덱스2)
//		if (num[0] > num[2]) {
//			int temp = num[0];
//			num[0] = num[2];
//			num[2] = temp;
...
//		printData(num);
//		
//		//첫번째 값 기준으로 네번쩨 값과 비교작업(인덱스0 - 인덱스3)
//			if (num[0] > num[3]) {
//				int temp = num[0];
//				num[0] = num[3];
//				num[3] = temp;
...
//			printData(num);
//			
//		//첫번째 값 기준으로 다섯번쩨 값과 비교작업(인덱스0 - 인덱스4)
//		if (num[0] > num[4]) {
//			int temp = num[0];
//			num[0] = num[4];
//			num[4] = temp;
