...
public class Ex01_array {
	...
	public static void main(String[] args) {
		...
		/* 배열(Array) : 동일한 데이터타입의 데이터를 동일한 변수명으로 사용
		배열의 선언 : 자료형[] 변수명
		...
		*/
		...
		int[] arr = new int[7];//int타입 데이터 7개 저장 공간 생성
		System.out.println("arr : " + arr);
		System.out.println("arr[0] : " + arr[0]);
		arr[0] = 100; //int타입 arr배열의 첫번째 위치(0번 인덱스)
		System.out.println("arr[0] : " + arr[0]);
