...
public class Stack_Queue {
	...
	public static void main(String[] args) {
		...
		System.out.println("que.peek() : " + que.peek()); // 맨 처음 데이터 조회됨
...
//		System.out.println("que.poll() : " + que.poll());
		...
		System.out.println("st.peek() : " + st.peek()); //맨 마지막 입력 데이터 조회됨
		System.out.println("st.peek() : " + st.peek());
		System.out.println("st.peek() : " + st.peek());
		System.out.println("st.size() : " + st.size());
		
		//peek() : 데이터 확인만(현재 사용 가능)
		//pop() : 꺼내서 사용하기
		//	데이터가 없을 때 pop() 실행시 EmptyStackException 예외 발생
//		System.out.println("st.pop() : " + st.pop());
//		System.out.println("st.pop() : " + st.pop());
//		System.out.println("st.pop() : " + st.pop());
//		System.out.println("st.pop() : " + st.pop()); //EmptyStackException 예외 발생
		System.out.println(st);
		
		System.out.println("st.size() : " + st.size());
		
		System.out.println("--- 스텍(Stack) 전체 데이터 조회 ---");
