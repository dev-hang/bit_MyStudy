...
public class SEAT_INFO_VO {
	...
	public SEAT_INFO_VO(String customer_id, String seat_num, String seat_grade, int concert_num, int seat_price,
			String haveseat) {
		super();
	...
	public String toString() {
		return "SEAT_INFO_VO [customer_id=" + customer_id + ", seat_num=" + seat_num + ", seat_grade=" + seat_grade
				+ ", concert_num=" + concert_num + ", seat_price=" + seat_price + ", haveseat=" + haveseat + "]";
	}
